...
\begin{center}
  ...
  \LARGE{$\beta1.3.0$ --- By Niko Lepka}\\
  \Large{\today}
\end{center}
\end{titlepage}
% this part adds an empty page after the title page. DO NOT REMOVE
\newpage
\null
\pagestyle{empty}
\newpage
\pagenumbering{arabic} % count pages from here.
...
\begin{center}
    \begin{tabular}{cccc}
        ...
        Patrick A. & Peter L. Erichsen & Thomas G. McCollin \\
    \end{tabular}
\end{center}
