...
\usepackage{textcomp}
    \tcbuselibrary{skins}
\usepackage[sc, explicit]{titlesec}
...
\newtcolorbox{note}{
    ...
    underlay={%
        ...
        \path[fill=gray!50!black,draw=none] (interior.south west) rectangle node[white]{\Huge\bfseries \textinterrobang} ([xshift=8mm]interior.north west);
    },
    drop fuzzy shadow % adds drop shadow
}

\newtcolorbox{example}{title = \textsc{Example}}