...
\newpage
\subsection{Phases}
Combat in Siren is split into two distinct phases: \textit{Proactive} and \textit{Reactive}.
...
The proactive phase is what you would think of as ``your turn'', during your turn you can pick any two of the following actions: \textit{Moving}, \textit{Bracing}, or \textit{Attacking}.
...
\textbf{Alex, this is part of the old write-up, that I've left in because of time.}
...
\subsection{Health Points}\label{sec:health-points}
...
\subsection{Fatigue Points}\label{sec:fatigue-points}
