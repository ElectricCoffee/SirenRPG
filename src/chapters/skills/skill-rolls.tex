...
\paragraph{Example} Say Alice wants to persuade a guard to do something stupid. 
Her \textit{Persuasion} skill is at 13. 
She rolls 3d6, and rolls a 1, a 5, and a 3, which is 9 in total. 
This means she successfully persuades the guard.
...
\paragraph{Note to players coming from other systems} The skill system may be reversed from what you're used to, and may require some re-adjustment time.
In a lot of systems any given challenge has a challenge rating, which the player has to exceed via a dice-roll + some modifiers.
In Siren it's the complete opposite: a given challenge has a number of modifiers associated with it, which then affect how hard it is to perform.
\newpage
