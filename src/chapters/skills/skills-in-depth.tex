\section{Skills in Depth}\label{sec:skills-in-depth}
\subsection{Mental Skills}
\subsubsection{Academics (Log + Log)}
...
\subsubsection{Investigation (Log + Int)}
...
\subsubsection{Perception (Log + Int)}
...
\subsubsection{Survival (Con + Log)}
...
\subsubsection{Thievery (Dex + Log)}
...
\subsubsection{Contacts (Cha + Log)}
...
\subsubsection{Crafting (Dex + Log)}
...
\subsubsection{Vehicle, Air (Dex + Log)}
...
\subsubsection{Vehicle, Land (Dex + Int)}
...
\subsubsection{Vehicle, Sea (Dex + Log)}
