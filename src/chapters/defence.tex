...
\begin{enumerate}
    \item \textbf{Dodge.} Roll against your \textit{Speed} trait + Defence Bonus.
    \item \textbf{Parry.} Roll against half of your weapon/fighting skill, rounded down + Defence Bonus.
\end{enumerate}
You get an additional $+2$ to your roll if you also choose to move out of the way of the attack.

\section{Defence Modifier}
Defence modifier (DfM), is defence modifier gained from your armour.
