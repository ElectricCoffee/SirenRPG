...
\note The use of XP during character progression is slightly different than that of character creation (Chapter~\ref{chap:char-creat}), so pay close attention to the following sections.
...
\example This levelling session, Joyce wants to increase her character's \textit{Wisdom}. 
...
\note XP is earned individually, not for the entire party.
...
\note It's of course up to the GM how much XP is awarded, this is meant as more of a guide than a hard rule.
