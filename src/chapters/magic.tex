...
Every character has a mana pool $Log \times Int$ in size, which represents the amount of magical potential your character can tap into without straining themselves.
In other words, if your character has 5 Log, and 6 Int, they have 30 Mana Points (MP).
