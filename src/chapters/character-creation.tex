...
\item \textbf{Def:}   Your character's Passive Defence score, see chapter~\ref{chap:defence} for more info
...
These specialisations---or proficiencies---follow the \textit{Experience Points} section below.
